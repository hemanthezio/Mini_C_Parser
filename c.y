...
%token FOR WHILE DO 
%token IF ELSE PRINTF RETURN BREAK CONTINUE DEFINE CASE SWITCH DEFAULT MAIN
%token STRUCT UNION
%token NUM ID
%token INCLUDE
%token DOT
...
start: MainFunction
     ...
     | multi_Declaration  MainFunction 
     | Functionproto MainFunction multi_Function
     | include multi_Declaration MainFunction
     | include Functionproto MainFunction multi_Function
     | multi_Declaration Functionproto MainFunction multi_Function
     | include  multi_Declaration Functionproto MainFunction multi_Function
     ;
...
/* Function protro-type declaration */
Functionproto: Type ID '(' ArgListOpt ')'';' 
	     | Functionproto Type ID '(' ArgListOpt ')'';' 
	     ;	
